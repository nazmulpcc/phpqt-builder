...
$captureConnection = \Qt\Core\QObject::connect(
    $worker,
...
$captureHits = (int) $worker->property('phase31_capture_hits');
$capturedName = (string) $worker->property('phase31_captured_name');
$captureThreadId = (string) $worker->property('phase31_capture_thread');
$captureSenderClass = (string) $worker->property('phase31_capture_sender_class');
$captureSenderSignal = (int) $worker->property('phase31_capture_sender_signal');
...
qt_runtime_result([
    ...
    'capture_hits' => $captureHits,
    'captured_name' => $capturedName,
    'capture_thread_id' => $captureThreadId,
    'capture_on_worker_thread' => $captureThreadId !== '' && $captureThreadId === $workerThreadId,
    'capture_sender_class' => $captureSenderClass,
    'capture_sender_signal' => $captureSenderSignal,
    'connections_are_objects' => $startedConnection instanceof \Qt\Core\QMetaObjectConnection
        && $captureConnection instanceof \Qt\Core\QMetaObjectConnection
